'''
    Sophie Nguyen 
    Used Mediapipe framework of Google to create Angry Birds game app playing without using a mouse.
    Hand Landmarks Detection Using Mediapipe In Python
    Used pydirectinput open source (https://github.com/learncodebygaming/pydirectinput)
'''
...
with mp_hands.Hands(
    ...
    min_detection_confidence=0.5) as hands:
        for idx, file in enumerate(IMAGE_FILES):
            ...
            print('Hundedness:', results.multi_handedness)
            if not results.multi_hand_landmarks:
                continue
            image_height, image_width, _ = image.shape # get image shape
